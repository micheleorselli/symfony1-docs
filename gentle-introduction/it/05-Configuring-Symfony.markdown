...
Si possono aggiungere commenti (che devono cominciare con il cancelletto #) e spazi aggiuntivi, per rendere ancora più leggibili tuoi file YAML, come mostrato nel Listato 5-7.
...
Listato 5-8 - La configurazione predefinita è mostrata commentata
    ...
    # Se vuoi cambiare questa impostazioni, scommentare la linea
    settings:
      cache: true
